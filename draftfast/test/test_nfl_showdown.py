...
def _build_mock_player_pool():
    player_pool = [
        ...
        Player(
            name="A7", cost=5500, proj=46, pos="RB", team="X", matchup="X@Y"
        ),
        Player(
        ...
        Player(
            name="A10", cost=5500, proj=49, pos="TE", team="X", matchup="X@Y"
        ),
        Player(
            name="A12", cost=5500, proj=51, pos="DST", team="X", matchup="X@Y"
        ),
        Player(
            name="A14", cost=5500, proj=40, pos="QB", team="Y", matchup="X@Y"
        ),
        Player(
            name="A21", cost=5500, proj=41, pos="QB", team="Y", matchup="X@Y"
        ),
        Player(
            name="A11", cost=5500, proj=50, pos="WR", team="Y", matchup="X@Y"
        ),
        Player(
            name="A31", cost=5500, proj=42, pos="WR", team="Y", matchup="X@Y"
        ),
        Player(
            name="A41", cost=5500, proj=43, pos="WR", team="Y", matchup="X@Y"
        ),
        Player(
            name="A51", cost=5500, proj=54, pos="WR", team="Y", matchup="X@Y"
        ),
        Player(
            name="A61", cost=5500, proj=45, pos="RB", team="Y", matchup="X@Y"
        ),
        Player(
            name="A71", cost=5500, proj=56, pos="RB", team="Y", matchup="X@Y"
        ),
        Player(
            name="A81", cost=5500, proj=47, pos="RB", team="Y", matchup="X@Y"
        ),
        Player(
            name="A91", cost=5500, proj=48, pos="TE", team="Y", matchup="X@Y"
        ),
        Player(
            name="A110", cost=5500, proj=49, pos="TE", team="Y", matchup="X@Y"
        ),
        Player(
            name="A112", cost=5500, proj=60, pos="DST", team="Y", matchup="X@Y"
        ),
    ]
